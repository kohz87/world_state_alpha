...
| Storage schema version drift | Application bugfix release accidentally changes durable format versions | decouple app version (0.9.0-alpha.10) from canonical schema 2 and sidecar/bundle/journal envelope version 1 | Phase 8/9 static version validators |
