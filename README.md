...
**Phases 1-5 are implemented as candidates: canonical state/rollback, immediate capture, local relevance/private injection, bounded lazy evolution, and host-neutral manual controls/rebuild. Phase 6 and later remain gated until separately authorized.**
...
Phases 1-5 authorize the canonical state/rollback substrate, bounded immediate capture, deterministic local relevance/private injection, targeted lazy evolution, and host-neutral manual inspection/correction/transfer/rebuild services. UI, command registration, coexistence host wiring, and SillyTavern bootstrap remain later-phase work.
