...
test('Phase 8 compatibility accepts current Phase 9 application versions while envelope versions remain 1', () => {
  ...
  assert.ok(['0.8.0-alpha.1', '0.9.0-alpha.1', '0.9.0-alpha.2', '0.9.0-alpha.3', '0.9.0-alpha.4', '0.9.0-alpha.5', '0.9.0-alpha.6', '0.9.0-alpha.7', '0.9.0-alpha.8', '0.9.0-alpha.9', '0.9.0-alpha.10', '0.9.0-alpha.11', '0.9.0-alpha.12', '0.9.0-alpha.13'].includes(pkg.version));
  assert.ok(['0.8.0-alpha.1', '0.9.0-alpha.1', '0.9.0-alpha.2', '0.9.0-alpha.3', '0.9.0-alpha.4', '0.9.0-alpha.5', '0.9.0-alpha.6', '0.9.0-alpha.7', '0.9.0-alpha.8', '0.9.0-alpha.9', '0.9.0-alpha.10', '0.9.0-alpha.11', '0.9.0-alpha.12', '0.9.0-alpha.13'].includes(manifest.version));
  assert.match(index, /WORLD_STATE_ALPHA_VERSION\s*=\s*'(0\.8\.0-alpha\.1|0\.9\.0-alpha\.1|0\.9\.0-alpha\.2|0\.9\.0-alpha\.3|0\.9\.0-alpha\.4|0\.9\.0-alpha\.5|0\.9\.0-alpha\.6|0\.9\.0-alpha\.7|0\.9\.0-alpha\.8|0\.9\.0-alpha\.9|0\.9\.0-alpha\.10|0\.9\.0-alpha\.11|0\.9\.0-alpha\.12|0\.9\.0-alpha\.13)'/);
