...
if (!['phase5-manual-rebuild', 'phase6-ui-evidence', 'phase7-coexistence-host', 'phase8-release-hardening', 'phase9-spatial-continuity'].includes(inventory.stage)) throw new Error('Phase 5 cumulative runtime inventory stage mismatch');
if (!['phase7-coexistence-host', 'phase8-release-hardening', 'phase9-spatial-continuity'].includes(inventory.stage) && inventory.hostEntrypoint !== null) throw new Error('Phase 5 service substrate must remain host-neutral before the authorized host phase');
