...
if (pkg.version !== '0.9.0-alpha.1' || manifest.version !== pkg.version) {
  throw new Error('Phase 9 application version markers inconsistent in package.json/manifest.json');
}
if (!indexSource.includes("WORLD_STATE_ALPHA_VERSION = '0.9.0-alpha.1'")) {
  throw new Error('Phase 9 index.js version marker not synchronized to 0.9.0-alpha.1');
}
...
console.log('World State Alpha Phase 9 validation passed: version 0.9.0-alpha.1 synchronized, schemaVersion 2 durable, spatial base map adapter verified, authority firewall validated, narrative sanitizer working, and spatial relevance indexing bounded.');
